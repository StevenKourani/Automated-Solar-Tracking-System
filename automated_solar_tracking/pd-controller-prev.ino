...
#define LDR_TL_PIN A3
#define LDR_TR_PIN A2
#define LDR_BL_PIN A1
#define LDR_BR_PIN A0
...
// PD Gains
const float Kp_az  = 0.30;
const float Kd_az  = 0.05;
const float Kp_alt = 0.30;
const float Kd_alt = 0.05;
...
const unsigned long interval = 10UL * 1000UL;  // 10 seconds
